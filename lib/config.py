...
__C.CLASSES = 'Car'
__C.IS_STUDENT = True
__C.DISTILL_WEIGHT= 0.1 
__C.DISTILL_LOSS_TYPE= 'combined'
__C.DISTILL_TEMPERATURE= 3.0
...
__C.USE_IM_DEPTH = False
__C.USE_PSEUDO_LIDAR = False
__C.CROSS_FUSION = False
__C.INPUT_CROSS_FUSION = False
__C.USE_KNN_FUSION = False
__C.USE_SELF_ATTENTION = False
__C.DEEP_RCNN_FUSION = False
__C.USE_IMAGE_LOSS = False
__C.IMAGE_WEIGHT = 1.0
__C.USE_IMAGE_LOSS_TYPE = 'CrossEntropyLoss'
__C.USE_IMAGE_SCORE = False
__C.USE_IMG_DENSE_LOSS = False
__C.USE_KL_LOSS = False
__C.USE_KL_LOSS_TYPE = 'KL'
__C.MC_LOSS_WEIGHT = 1.0
__C.SAVE_MODEL_PREP = 0.8
__C.USE_P2I_GATE = False
__C.STACK_CROSS_FUSION = False
__C.USE_IMAGE_RES = False
__C.RCNN_IMG_CHANNEL = 32
__C.ONLY_USE_IMAGE_FEAT = False
__C.USE_POINT_ATT_FEATURE = False
__C.USE_POINT_FEATURE_RES = False
__C.I2P_Weight = 0.5
__C.P2I_Weight = 0.5
__C.USE_MC_LOSS = False
__C.ADD_MC_MASK = False
__C.MC_MASK_THRES = 0.45
__C.USE_PURE_IMG_BACKBONE = False
__C.USE_PAINTING_SCORE = False
__C.USE_PAINTING_FEAT = False
...
__C.RPN.BACKBONE = 'pointnet2_msg'
__C.RPN.USE_BN = True
__C.RPN.NUM_POINTS = 13056  # Updated

__C.RPN.SA_CONFIG = edict()
__C.RPN.SA_CONFIG.ATTN_DIM = 128
__C.RPN.SA_CONFIG.ATTN = [0, 0, 128, 128]
__C.RPN.SA_CONFIG.NPOINTS = [3280, 820, 204, 64]  # Updated
__C.RPN.SA_CONFIG.RADIUS = [[0.1, 0.5], [0.5, 1.0], [1.0, 2.0], [2.0, 4.0]]
__C.RPN.SA_CONFIG.NSAMPLE = [[16, 32], [16, 32], [16, 32], [16, 32]]  # Kept the same
__C.RPN.SA_CONFIG.MLPS = [[[13, 13, 26], [26, 26, 51]],  # Updated
                          [[51, 51, 102], [51, 77, 102]],  # Updated
                          [[102, 157, 205], [102, 157, 205]],  # Updated
                          [[205, 205, 410], [205, 307, 410]]]  # Updated
__C.RPN.FP_MLPS = [[128, 128], [205, 205], [410, 410], [410, 410]]  # Updated
__C.RPN.CLS_FC = [128]  # Updated
__C.RPN.REG_FC = [128]  # Updated
...
__C.RCNN.SA_CONFIG.MLPS = [[128, 128, 128],
                           [128, 128, 256],
                           [256, 256, 512]]
__C.RCNN.CLS_FC = [256, 256]  # Updated
__C.RCNN.REG_FC = [256, 256]  # Updated
